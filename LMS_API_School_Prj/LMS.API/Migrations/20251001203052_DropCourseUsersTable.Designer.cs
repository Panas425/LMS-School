...
namespace LMS.API.Migrations
{
    ...
    [Migration("20251001203052_DropCourseUsersTable")]
    partial class DropCourseUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Start = new DateTime(2025, 10, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2814)
                        },
                        new
                        {
                            ...
                            Name = "Physics 101",
                            Start = new DateTime(2025, 10, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2817)
                        });
                });
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3ccdff16-e159-41ed-9970-75720c1dd5b8"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Functions",
                            End = new DateTime(2025, 11, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2982),
                            Name = "Functions",
                            Start = new DateTime(2025, 10, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2979)
                        },
                        new
                        {
                            Id = new Guid("0469a831-197b-4795-b05d-0016cafcef16"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Polynomials",
                            End = new DateTime(2025, 12, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2994),
                            Name = "Polynomials",
                            Start = new DateTime(2025, 11, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2993)
                        },
                        new
                        {
                            Id = new Guid("3d68ecfb-9934-4b90-981d-c739aa990aed"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Vektors",
                            End = new DateTime(2025, 11, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2996),
                            Name = "Vektors",
                            Start = new DateTime(2025, 10, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2996)
                        },
                        new
                        {
                            Id = new Guid("f0e204a6-e2b2-4dbf-b3e2-ba363eb3ca46"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Kinematics",
                            End = new DateTime(2025, 12, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2998),
                            Name = "Kimenatics",
                            Start = new DateTime(2025, 11, 1, 20, 30, 51, 896, DateTimeKind.Utc).AddTicks(2998)
                        });
                });
