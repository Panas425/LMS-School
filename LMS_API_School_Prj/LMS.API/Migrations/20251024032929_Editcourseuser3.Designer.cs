...
namespace LMS.API.Migrations
{
    ...
    [Migration("20251024032929_Editcourseuser3")]
    partial class Editcourseuser3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Start = new DateTime(2025, 10, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3136)
                        },
                        new
                        {
                            ...
                            Name = "Physics 101",
                            Start = new DateTime(2025, 10, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3139)
                        });
                });
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("94bbcb5d-75cd-4b16-9e08-4f8e04acd86b"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Functions",
                            End = new DateTime(2025, 11, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3329),
                            Name = "Functions",
                            Start = new DateTime(2025, 10, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3324)
                        },
                        new
                        {
                            Id = new Guid("52654fd6-8dd9-48e5-9b5d-35c0d2da5418"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Polynomials",
                            End = new DateTime(2025, 12, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3338),
                            Name = "Polynomials",
                            Start = new DateTime(2025, 11, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3337)
                        },
                        new
                        {
                            Id = new Guid("16a8ed31-08fb-4772-9ddd-b1b584e59760"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Vektors",
                            End = new DateTime(2025, 11, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3340),
                            Name = "Vektors",
                            Start = new DateTime(2025, 10, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3340)
                        },
                        new
                        {
                            Id = new Guid("780dacb0-a74e-400c-b3c5-e3f88a36cc99"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Kinematics",
                            End = new DateTime(2025, 12, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3343),
                            Name = "Kimenatics",
                            Start = new DateTime(2025, 11, 24, 3, 29, 29, 221, DateTimeKind.Utc).AddTicks(3342)
                        });
                });
