...
namespace LMS.API.Migrations
{
    ...
    [Migration("20251024015356_Editcourseuser")]
    partial class Editcourseuser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Start = new DateTime(2025, 10, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3752)
                        },
                        new
                        {
                            ...
                            Name = "Physics 101",
                            Start = new DateTime(2025, 10, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3756)
                        });
                });
            ...
            modelBuilder.Entity("LMS.API.Models.Entities.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5310e9e3-87e1-4c9e-a453-322285147400"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Functions",
                            End = new DateTime(2025, 11, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3935),
                            Name = "Functions",
                            Start = new DateTime(2025, 10, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3932)
                        },
                        new
                        {
                            Id = new Guid("7ec9a0b5-7221-41b1-8121-3aeeb9080c8e"),
                            CourseId = new Guid("6f01e571-41f0-4789-8059-422ae07d736e"),
                            Description = "Intro to Polynomials",
                            End = new DateTime(2025, 12, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3943),
                            Name = "Polynomials",
                            Start = new DateTime(2025, 11, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3942)
                        },
                        new
                        {
                            Id = new Guid("eac6c966-0d3a-45ef-8523-83b5fbb0daa7"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Vektors",
                            End = new DateTime(2025, 11, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3946),
                            Name = "Vektors",
                            Start = new DateTime(2025, 10, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3945)
                        },
                        new
                        {
                            Id = new Guid("073bd980-0561-4587-aefa-0f3ea8881506"),
                            CourseId = new Guid("a767cdee-e833-427a-9349-3ee71cca8a39"),
                            Description = "Intro to Kinematics",
                            End = new DateTime(2025, 12, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3949),
                            Name = "Kimenatics",
                            Start = new DateTime(2025, 11, 24, 1, 53, 55, 847, DateTimeKind.Utc).AddTicks(3948)
                        });
                });
